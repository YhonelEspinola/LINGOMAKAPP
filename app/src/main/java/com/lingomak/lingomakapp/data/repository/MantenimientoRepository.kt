    ...
    suspend fun solicitarReprogramacion(
        ...
        try {
            ...
            val solicitud = SolicitudMantenimientoEntity(
                ...
                horometroActual = maqActual.horometroActual,
                horometroUltimoMantenimiento = maqActual.horometroUltimoMantenimiento,
                intervaloMantenimientoHoras = maqActual.intervaloMantenimientoHoras,
                horasDesdeUltimoMantenimiento = (maqActual.horometroActual - maqActual.horometroUltimoMantenimiento),
                horasRestantes = (maqActual.intervaloMantenimientoHoras - (maqActual.horometroActual - maqActual.horometroUltimoMantenimiento)),
